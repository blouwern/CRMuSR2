...
PDRSupport::PDRSupport()
    : DescriptionBase{"PDRSupport"},
      fSTLFilePath{"PDRSupport.stl"},
      fPDRSupportThickness{1_cm}, fPDRSupportOuterWidth{71.6_cm},
      fPDRSupportBaseWidth{11_cm}, fPDRSupportHeight{71.6_cm},
      fPDRInnerPlatformHeight{2_cm}, fPDRSupportSpacing{0.2_cm} {
