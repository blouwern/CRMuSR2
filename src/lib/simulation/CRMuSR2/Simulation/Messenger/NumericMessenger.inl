namespace CRMuSR2::inline Simulation::inline Messenger {
...
NumericMessenger<AReceiver>::NumericMessenger() :
    ...
    fDirectory = std::make_unique<G4UIdirectory>("/CRMuSR2/Numeric/");
    fDirectory->SetGuidance("CRMuSR2 numeric controller.");

    fMinDriverStep = std::make_unique<G4UIcmdWithADoubleAndUnit>("/CRMuSR2/Numeric/MinDriverStep", this);
    ...
    fDeltaChord = std::make_unique<G4UIcmdWithADoubleAndUnit>("/CRMuSR2/Numeric/DeltaChord", this);
